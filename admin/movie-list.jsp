	...
	<body>
		...
		<div id="wrapper">
        	...
        	<ul id="navi-bar">
        	    ...
        	    <li>
        	    	<center>
        	        <a id="list" href="movie-list.jsp"  style="background-color: white; color: #52c0dc;">영화 목록</a>
        	        </center>
        	    </li>
        	    <li>
        	    	<center>
        	...
        	<div class="content-zone">
        		...
        		<%
					...
					String sqlStr = "SELECT * FROM movies order by title ASC, showtime ASC";
				...
				%>
						<td class="title"><%= rset.getString("title") %></td>
